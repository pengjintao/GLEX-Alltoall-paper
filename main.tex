...
\begin{abstract}
		...
		In this paper, we introduce an optimized multi-leader all-to-all library which explore the parallelism on network, CPU cores and overlap the intra- and inter-node communication. 
